...
{
    class MilkFoam : CoffeeDecorator
    {
        /// <summary>
        /// Add MilkFoam to the decorator pattern.
        /// </summary>
        public override int brew()
        {
            int startingPosition = base.brew();
            Console.WriteLine("Milk Foam: "+ startingPosition);
            return createImage("MilkFoam.png", startingPosition);
        }
    }
}
