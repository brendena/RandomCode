...
BasicGame.MainMenu.prototype = {
  ...
  update: function () {
    ...
    if(this.input.pointer1.isDown || this.input.activePointer.isDown){
      console.log("your amazing")
    }

    if (this.input.keyboard.isDown(Phaser.Keyboard.Z) || this.input.activePointer.isDown || this.input.pointer1.isDown || this.input.activePointer.isDown) {
      this.startGame();
    }
  ...
  render: function(){this.game.debug.pointer(this.game.input.pointer1);},
